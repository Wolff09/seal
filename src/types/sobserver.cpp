...
// SMR store
//
SmrObserverStore::SmrObserverStore(const Program& program, const Function& retire_function) : program(program), retire_function(retire_function), base_observer(prtypes::make_base_smr_observer(retire_function)) {
...
void SmrObserverStore::add_impl_observer(std::unique_ptr<Observer> observer) {
